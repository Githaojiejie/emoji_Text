...
namespace Assets.CommonLibs.Utility
{
    public static class CommonRuntimeUtility
    {
        ...
        {
            // Debug.Log("DebugLine {2} {0} to {1}", start, end, name);
        ...
        public static int GetCollisionLayers(int srcLayer)
        {
            ...
            for(int i = 0; i < 32; i++)
            {
                ...
                {
                    // Debug.Log("collide with {0}", LayerMask.LayerToName(i));
                    mask |= 1 << i; 
                }
            }
            return mask;
        ...
        public static string GetRuntimePlatformName()
        {
            ...
            case RuntimePlatform.Switch:
                ...
                default:
                    // Debug.Log("Unknown BuildTarget: Using Default Enum Name: {0}" , Application.platform);
