...
/// 文本控件，支持超链接、图片
/// </summary>
[AddComponentMenu("UI/EmojiText", 10)]
public class EmojiText : Text, IPointerDownHandler, IPointerClickHandler
{
    /// <summary>
    /// 是否3d（3d下不需要屏幕适配）
    /// </summary>
            ...
            if (img.sprite == null || img.sprite.name != spriteName)
            {
                               ...
                               if (!isloaded)
                {
                    ...
                    if (spriteName.Contains("http"))
                    {
                        ...
                        img.rectTransform.anchorMin = new Vector2(0.5f, 0.5f);  //new Vector2(align%3*0.5f, (1-align/3*0.5f));
